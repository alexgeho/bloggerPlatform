...
const delete_all_blogs_handler_1 = require("./handlers/delete-all-blogs.handler");
...
exports.blogsRouter
    ...
    .put('/:id', super_admin_guard_middleware_1.superAdminGuardMiddleware, params_id_validation_middleware_1.idValidation, blog_input_dto_validation_middlewares_1.blogInputDtoValidation, input_validtion_result_middleware_1.inputValidationResultMiddleware, update_driver_handler_1.updateBlogHandler)
    ...
    .delete('/testing/all-data', super_admin_guard_middleware_1.superAdminGuardMiddleware, delete_all_blogs_handler_1.deleteAllBlogHandler);
